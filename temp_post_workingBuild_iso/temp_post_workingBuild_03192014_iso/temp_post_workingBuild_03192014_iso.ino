...
#define CHANNEL_MAX 2 //set max cha 
...
#define HARDWARE_ID 4444001 //unique hardware id
//from post sketch
...
void post(int temperature, int id){
   ...
   data="";
   data+="hardware=" + (String)HARDWARE_ID +"&id=" + (String)id + "&temp=" + (String)temperature; // Use HTML encoding for comma's
